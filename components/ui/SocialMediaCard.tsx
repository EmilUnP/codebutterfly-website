      ...
      <div className="relative flex items-center justify-center bg-gradient-to-r from-cyber-dark/80 to-cyber-darker/80 backdrop-blur-sm border border-cyber-blue/20 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden h-14 w-64 rounded-xl group-hover:scale-105">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
          <div className="flex items-center justify-center space-x-8">
            ...
            >
              <svg 
                className="w-6 h-6 text-red-500 hover:text-red-400 transition-colors duration-200 group-hover/icon:scale-110" 
            ...
            >
              <svg 
                className="w-6 h-6 text-black hover:text-gray-700 transition-colors duration-200 group-hover/icon:scale-110" 
                viewBox="0 0 512 512" 
                fill="currentColor"
              >
            ...
            >
              <svg 
                className="w-6 h-6 text-[#5865F2] hover:text-[#4752C4] transition-colors duration-200 group-hover/icon:scale-110" 
